...
LPRPARSER connects to a TCP port on a Motorola LPR camera, and processes it using a Python script. The script extracts the raw data's license plates, vehicle information (make and model), and associated images.
